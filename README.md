...
## PLEASE TAKE NOTE
*Before starting the coding, from the Github file, make sure to `copy` the `pom.xml` to load maven dependencies (can be found within the root folder) & copy `application.properties` (can be found in resources).* 
